...
// require session and flash for storing browser_id's information
...
app.get('/farms', async (req, res) => {
    ...
    // pass flash message with 'success' key when render 'farms/index'
...
app.post('/farms', async (req, res, next) => {
    ...
    await farm.save();
    // access method flash from REQUEST => req.flash
    // pass in key (message category) value pair
    req.flash('success', 'Successfully create new farm!')
    res.redirect('/farms');
})
